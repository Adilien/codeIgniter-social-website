...
<body>
  ...
  <form class="search-form" action=<?php echo site_url("search/dosearch") ?> method="get">
    <!-- Sends the data from the from to the dosearch method via the get method in the Search controller -->
    Search:
    <br>
    <input type="text" name="search" value="" placeholder="Enter Search Terms...">
    <br><br>
